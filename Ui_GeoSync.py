...
#
# Created: Sun Jun  7 21:00:56 2015
...
class Ui_GeoSync(object):
    def setupUi(self, GeoSync):
        ...
        self.btnOK.setGeometry(QtCore.QRect(70, 560, 341, 32))
        ...
        self.btnLayertoRepo.setGeometry(QtCore.QRect(310, 520, 98, 27))
        self.btnLayertoRepo.setObjectName(_fromUtf8("btnLayertoRepo"))
        self.listMapLayers = QtGui.QListWidget(GeoSync)
        self.listMapLayers.setGeometry(QtCore.QRect(20, 130, 171, 291))
        ...
        self.btnGetMapLayers.setGeometry(QtCore.QRect(100, 490, 311, 27))
        self.btnGetMapLayers.setObjectName(_fromUtf8("btnGetMapLayers"))
        self.btnLoadfromRepo = QtGui.QPushButton(GeoSync)
        self.btnLoadfromRepo.setGeometry(QtCore.QRect(100, 460, 291, 27))
        ...
        self.btnLog.setGeometry(QtCore.QRect(180, 520, 98, 27))
        ...
        self.listRepoLayers = QtGui.QListWidget(GeoSync)
        self.listRepoLayers.setGeometry(QtCore.QRect(240, 130, 171, 291))
        self.listRepoLayers.setSelectionMode(QtGui.QAbstractItemView.MultiSelection)
        self.listRepoLayers.setObjectName(_fromUtf8("listRepoLayers"))
